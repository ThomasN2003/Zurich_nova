...
Decline if age is outside 18 to 70, term outside 5 to 40, BMI is 45 or above, or age plus term would take cover past age 75. A declined quote is still stored, with status DECLINED and no premium, and the API returns 409.
